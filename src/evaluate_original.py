...
from data_util import Dataset_ as Dataset_cfgs
import torch
...
def prepare_evaluation():
    ...
    parser.add_argument("--dset1", type=str, default="/home/test/varsha/images/valid/", help="specify the directory of the folder that contains real images.")
...
def evaluate(local_rank, args, world_size, gpus_per_node):
    ...
    dset2 = Dataset_cfgs(data_name="iNat19",
                                 data_dir="/home/test/varsha/images/all_368_368_images/",
                                 train=False,
                                 crop_long_edge=True,
                                 resize_size=64,
                                 random_flip=False,
